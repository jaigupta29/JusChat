...
import com.example.justalk.Activity.ChatActivity;
import com.example.justalk.Activity.HomeActivity;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull Viewholder holder, int position) {
        ...
        Picasso.get().load(users.getImageUri()).placeholder(R.drawable.signup).into(holder.user_profile);
